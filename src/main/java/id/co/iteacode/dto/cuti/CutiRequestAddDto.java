...
public class CutiRequestAddDto {

	private Long id;
	private String type;
	
	@NotNull(message = "Jumlah cuti tahunan tidak boleh kosong")
	...
	public String toString() {
		return "CutiRequestAddDto [id=" + id + ", type=" + type + ", jumlahCutiTahunan=" + jumlahCutiTahunan
